...
#define LCD_PUERTO PORTB	//La constante LCD_PUERTO se refiere a todo el puerto C
#define LCD_RS PB0			//La constante LCD_RS se refiere al pin de control RS del LCD, asociado al pin 8 del Puerto B en el Arduino
#define LCD_E PB1			//La constante LCD_E se refiere al pin de control E del LCD, asociado al pin 9 del Puerto B en el Arduino
