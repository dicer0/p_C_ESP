/*
 * 8_Frecuencia_timer_interrupciones.c
 *
 * Created: 30/05/2022 10:58:05 a. m.
 * Author : diego
 ...
 Pin 8	(PB0); Led con frecuencia variable
 ...
 Pin 1	(PD1)
 Pin 2	(PD2); INT0, Interrupción externa 0; Botón de - ; Para bajar frecuencia
 Pin 3	(PD3); INT1, Interrupción externa 1; Botón de + ; Para subir frecuencia
 Pin 4	(PD4)
